...
@section('content')
                ...
                <form action="{{ route('cars.update', $car->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control">
                            <option  {{ $car->status == 1 ? 'selected' : null }} value="Tersedia">Tersedia</option>
                            <option  {{ $car->status == 0 ? 'selected' : null }}  value="Tidak Tersedia">Tidak Tersedia</option>
                        </select>
                    </div>
                    <div class="form-group">
    ...
    <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('', $car->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="form-group">
                        <img src="{{ Storage::url($car->gambar) }} " class="img-fluid"   alt="">
                    </div>
                    <div class="div from-group">
